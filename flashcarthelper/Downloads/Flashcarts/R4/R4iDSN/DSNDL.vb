...
Public Class DSNDL
    ...
    Public Flashcart = "R4i"
    Dim r4dsndl As New System.Net.WebClient


    Private Sub r4dsn_Download(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
        SharedC.CheckDirStruct()
        If SharedC.InvalidPath = True Then
            Application.Exit()
        End If
        AddHandler r4dsndl.DownloadProgressChanged, AddressOf r4dsn_ProgressChanged
        AddHandler r4dsndl.DownloadFileCompleted, AddressOf r4dsn_DownloadCompleted
        r4dsndl.DownloadFileAsync(New Uri("http://filetrip.net/h35130793-Wood-R4iDSN.html"), Flashcartmenu.ExtPath + "/temp/woodr4.7z")
        Label1.Text = "Downloading Wood R4iDSN"
    End Sub
    Private Sub r4dsn_ProgressChanged(ByVal sender As Object, ByVal e As System.Net.DownloadProgressChangedEventArgs) 'Download Progress
        Dim bytesIn As Double = Double.Parse(e.BytesReceived.ToString())
        Dim totalBytes As Double = Double.Parse(e.TotalBytesToReceive.ToString())
        Dim percentage As Double = bytesIn / totalBytes * 100

        Progress.Value = Int32.Parse(Math.Truncate(percentage).ToString())
        Label1.Text = "Downloading Wood R4iDSN " + Progress.Value.ToString + "%"
        Label1.Refresh()
    End Sub

    Private Sub r4dsn_DownloadCompleted(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
        r4dsndl.CancelAsync()
        ExtR4()
        InstWood()
    ...
    Public Sub ExtR4() 'Exraction sub
        ...
        Label1.Text = "Extracting Wood R4iDSN"
    ...
    Public Sub InstWood() 'Renames Wood Directory to "woodr4"
        ...
        End If
        My.Computer.FileSystem.WriteAllText(Flashcartmenu.ExtPath + "/temp/woodren.bat", "title WoodRen" + vbNewLine + "cd %1\WoodR4iDSN_v*.**" + vbNewLine + "set WoodPath=%cd%" + vbNewLine + "cd .." + vbNewLine + "ren %woodpath% woodr4" + vbNewLine + "title WoodRen", False) 'Writes woodren.bat for wood renaming
        ...
        My.Computer.FileSystem.MoveFile(Flashcartmenu.ExtPath + "/woodr4/_DSMENU.DAT", Flashcartmenu.ExtPath + "/_DS_MENU.DAT", True)
