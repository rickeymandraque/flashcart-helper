...
echo This version will not work on Windows XP or below.
echo If you are on Windows XP or below, type "XP" (In capital letters), otherwise, 
echo press enter to continue
set /p xptest=
if "%xptest%" == "XP" goto FlashcartHelperXcopy
:wgettest
IF EXIST wget.exe. (
goto unrartest
) ELSE (
...
start /wait robocopy %cd%\CATSFC %cd%\Put_This_In_SD_card\CATSFC /s /e
...
start /wait robocopy 201002161705_moonshell210stable %cd%\Put_This_In_SD_card\ /s /e
